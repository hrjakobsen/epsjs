...
export const BUILT_INS_LIST: [string, OperatorFunction][] = [
  ...
  ['defaultmatrix', coordinateSystemMatrixOperators.defaultMatrix],
  ...
  ['file', fileOperators.file],
  ['write', fileOperators.write],
  ['writehexstring', fileOperators.writehexstring],
  ['writestring', fileOperators.writestring],
  ['print', fileOperators.print],
  ['readstring', fileOperators.readstring],
  ['read', fileOperators.read],
  ['readhexstring', fileOperators.readhexstring],
